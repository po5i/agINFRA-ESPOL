...
<link rel="stylesheet" type="text/css" href="simple.css?m=2012-06-18" />
<link rel="stylesheet" href="../../search/js/jquery-ui-1.8.21.custom.css" />
<link rel="stylesheet" href="../../search/js/select2.css" />
...
<script type="text/javascript" src="../../search/js/mustache.js"></script>
<script type="text/javascript" src="../../search/js/underscore-min.js"></script>
<script type="text/javascript" src="../../search/js/backbone-min.js"></script>
<script type="text/javascript" src="../../search/js/spin.min.js"></script>
<script type="text/javascript" src="../../search/js/spin.js"></script>
<script type="text/javascript" src="../../search/js/jquery.spin.js"></script>
<script type="text/javascript" src="../../search/js/jquery.flot.min.js"></script>
<script type="text/javascript" src="../../search/js/jquery.flot.pie.min.js"></script>
<script type="text/javascript" src="../../search/js/jquery.flot.selection.min.js"></script>
<script type="text/javascript" src="../../search/js/jquery.deparam.js"></script>
<script type="text/javascript" src="../../search/js/select2.js"></script>

<script type="text/javascript" src="../../search/es-backbone.js?m=2012-06-18"></script>
...
<script>
	function openSNV(center,container_id){
		...
		container.empty();
		html_header = '<div onclick="closeSNV(\''+center+'\',\''+container_id+'\')" class="close_snv"><img src="../../search/img/close.png" /></div>';
...
<div class="s5_body_background">
	...
	<div class="ag_footer">
		<img src="../../search/img/EUflag_logo.jpg">
		<img src="../../search/img/e-infrastructure_logo.jpg">
		<img src="../../search/img/FP7_capacities_logo.jpg">
	</div>
